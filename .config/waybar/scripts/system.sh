...
pkg_count="$(apt list --upgradeable 2>/dev/null | wc -l || echo "N/A")"
...
<span foreground="$PKG_FG">󰏖</span>  <span foreground="$FG_MAIN"><b>Package updates:</b></span> <span foreground="$FG_MUTED">$pkg_count</span>
EOF
)
